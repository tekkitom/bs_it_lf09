...
Das Netzwerk ist historisch gewachsen und größtenteils auf Ethernet (CAT 5e) mit 1\,GB umgestellt worden. Der Plan in Bild \ref{fig:NetzwerkVerwaltung} zeigt das Netzwerk, das am allgemeinen Firmen-Netzwerk angeschlossen ist. Teile der Verwaltung (EG, Gang 2) sind noch ältere CAT 5 Kabel verlegt. Dort ist auch noch ein älterer 100 MB Switch. Dieser Teil ist am Netzwerk der Firma angeschlossen.
...
Alle Switche im Firmen-LAN sind aktuelle Modelle namenhafter Hersteller. Der Switch in Verwaltung EG, Gang 2 (100 MB) ist ebenfalls von einem namenhaften Hersteller, er ist jedoch aus dem Jahr 2000.
...
\begin{itemize}
 ...
 \item Die neue Person wird zum Arbeitsplatz begleitet und erhält dort als Ausdruck alle Zugangsdaten (persönliche und allgemeine für Fernzugriff auf Server, ...). Unabhängig, welche Arbeiten die Person ausführen soll.
...
\begin{enumerate}
 \item Datenaustausch per Cloud – soll zügig erfolgen (Wunsch der neuen Geschäftsleitung). \\Die DSGVO muss gewährleistet werden, Vorgabe vom Datenschutz.
...
\begin{itemize}
 \item 2 Filialen haben nur einen PC im Büro und den Kassen PC, beide sind nicht vernetzt. Der BüroPC ist ein älteres Modell (Röhrenmonitor, ein PC 80486, der andere Pentium 2), die PCs sind nicht mit dem Internet verbunden. Betriebssystem: Windows 3.11
 \item 2 Filialen haben ein 10BaseT Netzwerk mit CAT 5 Leitungen. Im Büro befinden sich jeweils 2 PCs (Pentium 4), sie waren per ISDN angebunden, zurzeit gibt es keine Vernetzung nach außen. Der KassenPC ist nicht vernetzt. Betriebssystem: Windows 95
 ...
 \item 2 Filialen verfügen über zwei BüroPCs mit i3 (10100) und Cat 7 Netzwerk. Die Anbindung ist via VDSL (50 MBit). In jeder Filiale stehen zwei Kassen PCs, sie sind im LAN eingebunden. Betriebssystem: Windows 7 home
 \item 2 Filialen verfügen über zwei BüroPCs mit i5 (11600K) und Cat 7 Netzwerk. Die Anbindung ist via Glasfaser (400MBit). In jeder Filiale stehen zwei Kassen PCs, sie sind im LAN eingebunden. Betriebssystem: Windows 7 home
\end{itemize}
...
Der Internetzugriff erfolgt über TV-Kabel\footnote{Der Kabelanbieter ist ein kleineres, regionales Unternehmen. Es sind nur wenige Verteiler vorhanden und viele Kunden an einem Verteiler abgeschlossen. Der Ausbau der Infrastruktur soll zeitnah erfolgen.}. Telefon-Leitung liegt (auch DSL 1000 möglich). Die Zentrale ist außerhalb auf einem ehemaligen
...
Der Server, TV-Modem und ein zentraler Switch (100 MBit) stehen im Keller auf dem Fußboden. Im Obergeschoss gibt es einen zweiten Switch für das Obergeschoss. Im Erdgeschoss ist ein AP installiert. Das Passwort ist SuperMuellerInternet und steht auf einem Blatt an der Tür zum IT
Beauftragten. IT beauftragte sind in der Regel Azubis, da sie sich eher mit IT auskennen, als das übrige Personal. Die Firma bildet Kaufleute im
...
Auf dem Gelände wurden die Stomkabel zu Halle 1 und 2 unterirdisch verlegt. Die Freifläche ist vollständig betoniert. Eine Verlegung weiterer Kabel und Rohre ist nicht möglich. Die Stromversorgung des nachträglich gebauten Tiefkühllagers erfolgt oberirdisch in ca. 5m Höhe.
...
Innerhalb der Netzwerksegnemte können bei Bedarf weitere Netzwerke festgelegt werden.
